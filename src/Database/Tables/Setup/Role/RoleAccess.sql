CREATE TABLE [dbo].[RoleAccess] (
    ...
    CONSTRAINT [FK_RoleAccess_Module] 
        FOREIGN KEY ([ModuleId]) 
        REFERENCES [dbo].[Module] ([Id])
        ON DELETE CASCADE,
    CONSTRAINT [FK_RoleAccess_Role]
        FOREIGN KEY ([RoleId]) 
...
CREATE TRIGGER [dbo].[Trigger_RoleAccess_ColumnUpdates] ON [dbo].[RoleAccess] --Change to match your table name
...
SET @TABLE_NAME = 'RoleAccess'; ---Change to your table name
IF(@Action = 'Create')
BEGIN
