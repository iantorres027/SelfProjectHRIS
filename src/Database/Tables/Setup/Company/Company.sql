...
(
    ...
    [BusinessStyle] NVARCHAR(50) NOT NULL, 
    ...
    [RepresentativeName] NVARCHAR(255) NOT NULL, 
    [RepresentativeTin] NVARCHAR(50) NOT NULL,
    [RepresentativeDesignation] NVARCHAR(100) NOT NULL,
